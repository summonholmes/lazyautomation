...
```
λ choco install 7zip adb bleachbit choco-cleaner discord epicgameslauncher etcher ffmpeg FiraCode Firefox foobar2000 git gpg4win-light guitar-pro keepassxc microsoft-windows-terminal miniconda3 mpc-hc msvisualcplusplus2013-redist nano nomacs notepadplusplus protonmailbridge qbittorrent retroarch rufus simplewall slack steam sumatrapdf synctrayzor ungoogled-chromium unxUtils vim vscode youtube-dl -y
```
